Pod::Spec.new do |spec|
    ...
    spec.dependency 'FirebaseAuth', '~> 12.12.0'
    if !Dir.exist?('build/cocoapods/framework/auth.framework') || Dir.empty?('build/cocoapods/framework/auth.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ./gradlew :features:firebase:auth:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':features:firebase:auth',
        'PRODUCT_MODULE_NAME' => 'auth',
    }
    spec.script_phases = [
        {
            :name => 'Build AuthImplFirebase',
